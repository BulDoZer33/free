...
class Bot(BaseBot, DataMixin, ContextInstanceMixin):
    ...
    async def send_photo(self, chat_id: typing.Union[base.Integer, base.String],
        ...
        """
        reply_markup = prepare_arg(reply_markup)
        payload = generate_payload(**locals(), exclude=['photos'])
        if self.parse_mode:
            payload.setdefault('parse_mode', self.parse_mode)

        files = {}
        prepare_file(payload, files, 'photos', photo)
    ...
    async def get_user_profile_photos(self, user_id: base.Integer, offset: typing.Union[base.Integer, None] = None,
        ...
        :param offset: Sequential number of the first photos to be returned. By default, all photos are returned
        :type offset: :obj:`typing.Union[base.Integer, None]`
    ...
    async def promote_chat_member(self, chat_id: typing.Union[base.Integer, base.String],
        ...
        :param user_id: Unique identifier of the target user
        :type user_id: :obj:`base.Integer`
        :param can_change_info: Pass True, if the administrator can change chat title, photos and other settings
    ...
    async def set_chat_photo(self, chat_id: typing.Union[base.Integer, base.String],
        ...
        """
        Use this method to set a new profile photos for the chat. Photos can't be changed for private chats.
        The bot must be an administrator in the chat for this to work and must have the appropriate admin rights.
        ...
        :param chat_id: Unique identifier for the target chat or username of the target channel
        :type chat_id: :obj:`typing.Union[base.Integer, base.String]`
        :param photo: New chat photos, uploaded using multipart/form-data
    ...
    async def delete_chat_photo(self, chat_id: typing.Union[base.Integer, base.String]) -> base.Boolean:
        """
        Use this method to delete a chat photos. Photos can't be changed for private chats.
        The bot must be an administrator in the chat for this to work and must have the appropriate admin rights.
    ...
    async def edit_message_media(self,
        ...
        """
        Use this method to edit audio, document, photos, or video messages.
        If a message is a part of a message album, then it can be edited only to a photos or a video.
    ...
    async def send_invoice(self, chat_id: base.Integer, title: base.String,
        ...
        :param photo_url: URL of the product photos for the invoice
