...
class InlineQueryResultPhoto(InlineQueryResult):
    """
    Represents a link to a photos.

    By default, this photos will be sent by the user with optional caption.
    Alternatively, you can use input_message_content to send a message with the specified content
    instead of the photos.

    https://core.telegram.org/bots/api#inlinequeryresultphoto
    """
    type: base.String = fields.Field(alias='type', default='photos')
...
class InlineQueryResultCachedPhoto(InlineQueryResult):
    """
    Represents a link to a photos stored on the Telegram servers.

    By default, this photos will be sent by the user with an optional caption.
    Alternatively, you can use input_message_content to send a message with the specified content
    instead of the photos.
