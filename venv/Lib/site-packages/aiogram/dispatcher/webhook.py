...
class SendPhoto(BaseResponse, ReplyToMixin, DisableNotificationMixin):
    """
    Use that response type for send photos on to webhook.
    """
    ...
    def __init__(self, chat_id: Union[Integer, String],
        ...
        :param photo: String - Photo to send. Pass a file_id as String to send
            a photos that exists on the Telegram servers (recommended), pass an HTTP URL as a String for
            Telegram to get a photos from the Internet, or upload a new photos using multipart/form-data.
...
class DeleteChatPhoto(BaseResponse):
    """
    Use that response type for delete chat photos on to webhook.
    """
...
class SendInvoice(BaseResponse, ReplyToMixin, DisableNotificationMixin):
    ...
    def __init__(self, chat_id: Integer,
        ...
        :param photo_url: String (Optional) - URL of the product photos for the invoice.
            Can be a photos of the goods or a marketing image for a service.
